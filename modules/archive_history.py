...
from util import clean_domain_input
...
WAYBACK_CDX_API_URL = "http://wayback.archive-it.org/all/timemap/cdx"
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        target = input(f"{Fore.YELLOW}[?] Please enter the target domain or URL: {Style.RESET_ALL}").strip()
